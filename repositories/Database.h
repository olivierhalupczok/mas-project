...
// makeStorage must be defined (not just declared) here so that
// decltype(makeStorage("")) can deduce the return type at compile time.
inline auto makeStorage(const std::string& path) {
    using namespace sqlite_orm;
    return make_storage(path,
        make_table("companies",
            make_column("id",       &CompanyRecord::id,       primary_key().autoincrement()),
        ...
        make_table("recruiters",
            make_column("id",         &RecruiterRecord::id,         primary_key().autoincrement()),
        ...
        make_table("candidates",
            make_column("id",     &CandidateRecord::id,     primary_key().autoincrement()),
        ...
        make_table("job_postings",
            make_column("id",           &JobPostingRecord::id,          primary_key().autoincrement()),
        ...
        make_table("applications",
            make_column("id",              &ApplicationRecord::id,            primary_key().autoincrement()),
        ...
        make_table("interviews",
            make_column("id",             &InterviewRecord::id,             primary_key().autoincrement()),
        ...
        make_table("cv_documents",
            make_column("id",           &CVDocumentRecord::id,           primary_key().autoincrement()),
        ...
        make_table("cv_sections",
            make_column("id",              &CVSectionRecord::id,             primary_key().autoincrement()),
        ...
        make_table("skills",
            make_column("id",                 &SkillRecord::id,                 primary_key().autoincrement()),
        ...
        make_table("portfolio_entries",
            make_column("id",           &PortfolioEntryRecord::id,           primary_key().autoincrement()),
